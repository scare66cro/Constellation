...
extern void lwIPInit(uint32_t ui32SysClkHz, const uint8_t *pui8Mac,
		struct ip_addr ui32IPAddr, struct ip_addr ui32NetMask,
		struct ip_addr ui32GWAddr, uint32_t ui32IPMode);
...
extern void lwIPNetworkConfigChange(struct ip_addr ui32IPAddr, struct ip_addr ui32NetMask,
		struct ip_addr ui32GWAddr, uint32_t ui32IPMode);
