...
# (Only wipe OUT_C if we have nanopb; otherwise preserve existing C output
#  generated by the Windows generate.ps1.)
rm -rf "$OUT_TS"
mkdir -p "$OUT_TS"
...
elif python3 -c "import nanopb" 2>/dev/null; then
