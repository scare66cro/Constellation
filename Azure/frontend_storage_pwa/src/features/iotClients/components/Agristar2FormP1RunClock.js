...
import AS2FormP1RunTimes from "../hooks/AS2FormP1RunClock"
...
const TimeNode = props => {
    ...
    // --------HOOKS--------------
    const {mapModeToInfo} = AS2FormP1RunTimes()
    ...
    return(
        <div
            ...
            style={{
                width:`8%`,
                margin:'1px 0px',
                backgroundColor: mapModeToInfo[mode] ? mapModeToInfo[mode].color : mapModeToInfo[3].color,
...
const Agristar2FormP1RunClock = (props) => {
    const {
        isAuthorized,
        payloadToSend,
        saving,
    ...
    return(
        <SaveComponent saving={saving?.p1RunTimes?.status}>
            <div
            ...
            >  
                ...
                >
                    ...
                    {
                        payloadToSend.runTimes?.map((mode,index) => 
                            <TimeNode 
                                key={index}
                ...
                >
                    {
                        Object.keys(mapModeToInfo).map(b => 
                            <Button 
                                ...
                                disabled={!isAuthorized || (b === '4' && noRefrigeration)}
...
export default Agristar2FormP1RunClock